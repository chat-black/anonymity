...
{
	"gp_feature_not_yet", ERRCODE_GP_FEATURE_NOT_YET
},

{
	"gp_feature_not_configured", ERRCODE_GP_FEATURE_NOT_CONFIGURED
},
...
{
	"invalid_interval_width", ERRCODE_INVALID_INTERVAL_WIDTH
},
...
{
	"no_partition_for_partitioning_key", ERRCODE_NO_PARTITION_FOR_PARTITIONING_KEY
},
...
{
	"gp_operation_canceled", ERRCODE_GP_OPERATION_CANCELED
},
...
{
	"gp_reject_limit_reached", ERRCODE_T_R_GP_REJECT_LIMIT_REACHED
},
...
{
	"gp_command_error", ERRCODE_GP_COMMAND_ERROR
},
...
{
	"gp_memprot_kill", ERRCODE_GP_MEMPROT_KILL
},
...
{
	"mirror_ready", ERRCODE_MIRROR_READY
},
...
{
	"gp_interconnection_error", ERRCODE_GP_INTERCONNECTION_ERROR
},
...
{
	"fault_inject", ERRCODE_FAULT_INJECT
},
