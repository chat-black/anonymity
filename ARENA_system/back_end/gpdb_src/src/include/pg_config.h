...
#define GP_MAJORVERSION "6"

/* A string containing the Greenplum version number */
#define GP_VERSION "6.0.0-beta.1+995f61cc build dev"
...
#define PACKAGE_STRING "Greenplum Database 6.0.0-beta.1"
...
#define PACKAGE_VERSION "6.0.0-beta.1"
...
#define PG_VERSION_STR "PostgreSQL 9.4.24 (Greenplum Database 6.0.0-beta.1+995f61cc build dev) on x86_64-unknown-linux-gnu, compiled by gcc (Ubuntu 7.5.0-3ubuntu1~18.04) 7.5.0, 64-bit"
