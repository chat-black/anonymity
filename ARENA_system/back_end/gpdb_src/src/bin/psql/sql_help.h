...
extern void sql_help_ALTER_EXTERNAL_TABLE(PQExpBuffer buf);
...
extern void sql_help_ALTER_PROTOCOL(PQExpBuffer buf);
extern void sql_help_ALTER_RESOURCE_GROUP(PQExpBuffer buf);
extern void sql_help_ALTER_RESOURCE_QUEUE(PQExpBuffer buf);
...
extern void sql_help_CREATE_EXTERNAL_TABLE(PQExpBuffer buf);
...
extern void sql_help_CREATE_PROTOCOL(PQExpBuffer buf);
extern void sql_help_CREATE_RESOURCE_GROUP(PQExpBuffer buf);
extern void sql_help_CREATE_RESOURCE_QUEUE(PQExpBuffer buf);
...
extern void sql_help_DROP_EXTERNAL_TABLE(PQExpBuffer buf);
...
extern void sql_help_DROP_PROTOCOL(PQExpBuffer buf);
extern void sql_help_DROP_RESOURCE_GROUP(PQExpBuffer buf);
extern void sql_help_DROP_RESOURCE_QUEUE(PQExpBuffer buf);
...
static const struct _helpStruct QL_HELP[] = {
    ...
    { "ALTER EXTERNAL TABLE",
      N_("change the definition of an external table"),
      sql_help_ALTER_EXTERNAL_TABLE,
      12 },
    ...
    { "ALTER PROTOCOL",
      N_("change the definition of a custom data access protocol"),
      sql_help_ALTER_PROTOCOL,
      2 },

    { "ALTER RESOURCE GROUP",
      N_("change the limits of a resource group"),
      sql_help_ALTER_RESOURCE_GROUP,
      7 },

    { "ALTER RESOURCE QUEUE",
      N_("change attributes of a resource queue"),
      sql_help_ALTER_RESOURCE_QUEUE,
      19 },
    ...
    { "CLUSTER",
      N_("cluster a heap storage table according to an index"),
      sql_help_CLUSTER,
      1 },
    ...
    { "CREATE EXTERNAL TABLE",
      N_("define a new external table"),
      sql_help_CREATE_EXTERNAL_TABLE,
      87 },
    ...
    { "CREATE PROTOCOL",
      N_("create a custom data access protocol"),
      sql_help_CREATE_PROTOCOL,
      2 },

    { "CREATE RESOURCE GROUP",
      N_("define a new resource group"),
      sql_help_CREATE_RESOURCE_GROUP,
      7 },

    { "CREATE RESOURCE QUEUE",
      N_("create a new resource queue for workload management"),
      sql_help_CREATE_RESOURCE_QUEUE,
      11 },
    ...
    { "CREATE TRIGGER",
      N_("define a new trigger (user-defined triggers are not fully supported in Greenplum Database)"),
    ...
    { "DROP EXTERNAL TABLE",
      N_("remove an external table definition"),
      sql_help_DROP_EXTERNAL_TABLE,
      0 },
    ...
    { "DROP PROTOCOL",
      N_("remove a custom access protocol"),
      sql_help_DROP_PROTOCOL,
      0 },

    { "DROP RESOURCE GROUP",
      N_("remove a resource group"),
      sql_help_DROP_RESOURCE_GROUP,
      0 },

    { "DROP RESOURCE QUEUE",
      N_("remove a resource queue"),
      sql_help_DROP_RESOURCE_QUEUE,
      0 },
...
#define QL_HELP_COUNT	173		/* number of help items */
