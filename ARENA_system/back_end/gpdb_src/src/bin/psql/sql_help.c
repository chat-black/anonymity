...
void
sql_help_ALTER_EXTERNAL_TABLE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
void
sql_help_ALTER_PROTOCOL(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
void
sql_help_ALTER_RESOURCE_GROUP(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
void
sql_help_ALTER_RESOURCE_QUEUE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
sql_help_ALTER_ROLE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "ALTER ROLE %s RESOURCE QUEUE {%s | NONE}\n"
					  "ALTER ROLE %s RESOURCE GROUP {%s | NONE}",
					  _("name"),
					  _("option"),
					  _("where option can be:"),
					  _("connlimit"),
...
sql_help_ALTER_TYPE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "ALTER TYPE %s SET DEFAULT ENCODING ( storage_directive )\n"
					  "\n"
					  "%s\n"
					  "\n"
...
sql_help_COPY(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "    [ ON SEGMENT ]\n"
					  "    [ FILL MISSING FIELDS ]\n"
					  "    [ [LOG ERRORS] SEGMENT REJECT LIMIT %s [ [ROWS] | PERCENT ] ]\n"
					  "\n"
					  "COPY { %s [ ( %s [, ...] ) ] | ( %s ) }\n"
...
void
sql_help_CREATE_EXTERNAL_TABLE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
sql_help_CREATE_FOREIGN_DATA_WRAPPER(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "    [ HANDLER %s | NO HANDLER ]\n"
					  "    [ VALIDATOR %s | NO VALIDATOR ]\n"
					  "    [ OPTIONS ( [ mpp_execute 'any | master | all segments' ], %s '%s' [, ... ] ) ]",
					  _("name"),
					  _("handler_function"),
					  _("validator_function"),
					  _("option"),
...
{
	appendPQExpBuffer(buf,
					  "CREATE [ UNIQUE ] INDEX [ %s ] ON %s [ USING %s ]\n"
...
void
sql_help_CREATE_PROTOCOL(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
void
sql_help_CREATE_RESOURCE_GROUP(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
void
sql_help_CREATE_RESOURCE_QUEUE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
sql_help_CREATE_TABLE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  _("source_table"),
					  _("like_option"),
					  _("column_reference_storage_directive"),
					  _("parent_table"),
					  _("storage_parameter"),
					  _("value"),
					  _("tablespace_name"),
...
void
sql_help_DROP_EXTERNAL_TABLE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  "DROP EXTERNAL [WEB] TABLE [ IF EXISTS ] %s [ CASCADE | RESTRICT ]",
					  _("name"));
}
...
void
sql_help_DROP_PROTOCOL(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
...
void
sql_help_DROP_RESOURCE_GROUP(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  "DROP RESOURCE GROUP %s",
					  _("group_name"));
}

void
sql_help_DROP_RESOURCE_QUEUE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  "DROP RESOURCE QUEUE %s [, ...]",
					  _("name"));
}
